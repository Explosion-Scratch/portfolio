<script>
  ...
  function getMailto(project) {
    return 'mailto:explosionscratch@gmail.com?' + encodeURI("subject=Project Access Request - $TITLE&body=Hi!\r\n\r\nI'm writing to request access to the code of the following project. I won't modify, redistribute, share, or sell the code or things generated by / created by this project in any way. @Explosion-Scratch (explosionscratch@gmail.com) reserves the right to modify these conditions at any time.\r\n\r\nProject:\r\n\r\nTitle:                   $TITLE\r\nCode URL:         $CODE_URL\r\nDescription:      $DESCRIPTION\r\n\r\nSincerely,\r\n[Your name]"
      .replaceAll("$TITLE", project.title)
      .replaceAll("$CODE_URL", project.code_link)
      .replaceAll("$DESCRIPTION", project.description));
  }
</script>

<div class="project_modal_wrapper" class:closeHovered>
  <div
    class="closeWrapper"
  ...
  <div class="left">
    ...
    {/if}
    {#if project.link && project.link.includes("coding_backup")}
      <div class="buttons">
        <a use:tooltip={'Send me an email - Click to compose'} href="{getMailto(project)}" class="primary">
          <AnimatedIcon>
            <svg
...
<style lang="scss" scoped>
  ...
  .img_container {
    $color: white;
    box-shadow:
      rgba($color, 0.05) 0px 6px 24px 0px,
  ...
  .project_modal_wrapper {
    ...
    &.closeHovered {
      ...
      $shadow: $primary;
      box-shadow:
        0 20px 25px -5px rgb($shadow, 0.4),
