<div class="wrapper profile">
  <div class="profile-card">
    <div class="profile-card__img">
      <img
        src="https://avatars.githubusercontent.com/u/61319150?v=4"
        alt="profile card"
      />
    </div>

    <div class="profile-card__cnt">
      <div class="profile-card__name">Explosion-Scratch</div>
      <div class="profile-card__txt">
        Fullstack JavaScript developer at <strong>NASA</strong>
      </div>
      <div class="profile-card-loc">
        ...
        <span class="profile-card-loc__txt"> America =) </span>
      </div>

      <div class="profile-card-inf">
        <div class="profile-card-inf__item">
          <div class="profile-card-inf__title">58</div>
        ...
        <div class="profile-card-inf__item">
          <div class="profile-card-inf__title">44</div>
          <div class="profile-card-inf__txt">Repositories</div>
        </div>

        <div class="profile-card-inf__item">
          <div class="profile-card-inf__title">17.1k</div>
          <div class="profile-card-inf__txt">Commits</div>
        </div>
      </div>

      <div class="profile-card-social">
        <a
          href="https://www.youtube.com/channel/UCL3Ot9VbjDCZwKn8AHJJCBA"
          class="profile-card-social__item youtube"
          target="_blank"
        >
        ...
        <a
          href="https://dev.page/explosion"
          class="profile-card-social__item devpage"
          target="_blank"
        >
          <span class="icon-font">
            <svg class="icon"><use xlink:href="#icon-devpage" /></svg>
          </span>
        </a>

        <a
          href="https://github.com/explosionscratch"
        ...
        <a
          href="https://codepen.io/explosion-scratch"
      ...
      <div class="profile-card-ctr">
        <button class="profile-card__button button--orange">View work</button>
  ...
  .profile-card {
    ...
    &-social {
      ...
      &__item {
        ...
        &.devpage {
          background: linear-gradient(45deg, #921df2, #0e71c8);
          box-shadow: 0px 4px 30px rgba(19, 127, 212, 0.7);
        }

        &.youtube {
          background: linear-gradient(45deg, #f55, #600);
